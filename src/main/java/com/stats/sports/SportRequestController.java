...
/**
 * A controller for sport requests of the the sports statistics application.
 *
 ...
 */
@Controller
public final class SportRequestController {
    /**
     * The connection of the {@code SportRequestController} class.
     */
    private static final Connection connection;

    /**
     * The next sport ID of the {@code SportRequestController} class.
     */
    ...
    private static int getSportId() {
        ...
        Objects.requireNonNull(SportRequestController.connection, "the connection is null");

        query = "SELECT MAX(sport_id) AS max_id FROM sports;";

        try (var statement = SportRequestController.connection.createStatement()) {
    ...
    public String addSportSubmit(@ModelAttribute Sport sport, Model model) {
        ...
        id = SportRequestController.nextSportId;

        SportRequestController.nextSportId++;

        name = sport.getName();

        insertStatement = "INSERT INTO sports (sport_id, name) VALUES (?, ?);";

        try (var preparedStatement = SportRequestController.connection.prepareStatement(insertStatement)) {
    ...
    public String editSportSubmit(@ModelAttribute EditSport editSport, Model model) {
        ...
        try (var preparedStatement = SportRequestController.connection.prepareStatement(updateStatement)) {
    ...
    public String deleteSportSubmit(@ModelAttribute DeleteSport deleteSport, Model model) {
        ...
        try (var preparedStatement = SportRequestController.connection.prepareStatement(deleteStatement)) {
            preparedStatement.setInt(idIndex, id);
    ...
    public String searchSportSubmit(@ModelAttribute Sport sport, Model model) {
        ...
        try (var preparedStatement = SportRequestController.connection.prepareStatement(searchQuery)) {
            preparedStatement.setString(nameIndex, name);
